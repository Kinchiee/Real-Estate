        ...
        <div class="d-none d-md-block col-md-4 col-xl-4 left-wrapper">
            <div class="card rounded">
                <div class="card-body">
                    ...
                    <p>Hi! I'm Amiah the Senior UI Designer at YourService. We hope you enjoy the design and quality of Social.</p>
                    <div class="mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{route('admin.update.password')}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="old_password" class="form-control @error('old_password') is-invalid @enderror" id="password" autocomplete="off"">
                                @error('old_password')
