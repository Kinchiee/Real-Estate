...
<title>RealEstate - Your Dream House</title>
...
<link rel="stylesheet" href="{{asset('frontend/assets/css/color/theme-color.css')}}" id="jssDefault">
<link rel="stylesheet" href="{{asset('frontend/assets/css/switcher-style.css')}}">
